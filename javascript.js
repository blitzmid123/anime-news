!(function (t, e) {
     ...
     forceUpdate: function () {
      if (!c) {
       var t = a.elements,
        ...
        i = t.popper;
       if (Be(e, i)) {
        (a.rects = { reference: je(e, te(i), "fixed" === a.options.strategy), popper: Kt(i) }),
         (a.reset = !1),
 ...
 const qe = Object.freeze({
  ...
  ai = { offset: [0, 2], boundary: "clippingParents", reference: "toggle", display: "dynamic", popperConfig: null, autoClose: !0 },
  li = { offset: "(array|string|function)", boundary: "(string|element)", reference: "(string|element|object)", display: "string", popperConfig: "(null|object|function)", autoClose: "(boolean|string)" };
 class ci extends B {
  constructor(t, e) {
  ...
  _getConfig(t) {
   if (
    ((t = { ...this.constructor.Default, ...U.getDataAttributes(this._element), ...t }), a(Fe, t, this.constructor.DefaultType), "object" == typeof t.reference && !o(t.reference) && "function" != typeof t.reference.getBoundingClientRect)
   )
    throw new TypeError(`${Fe.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
   return t;
  }
  _createPopper(t) {
 ...
 const fi = { className: "modal-backdrop", isVisible: !0, isAnimated: !1, rootElement: "body", clickCallback: null },
  pi = { className: "string", isVisible: "boolean", isAnimated: "boolean", rootElement: "(element|string)", clickCallback: "(function|null)" },
  mi = "show",
 ...
 class _i {
  ...
  _getConfig(t) {
   return ((t = { ...fi, ...("object" == typeof t ? t : {}) }).rootElement = r(t.rootElement)), a("backdrop", t, pi), t;
  }
  _append() {
   this._isAppended ||
 ...
 class Ei {
  ...
  _getConfig(t) {
   return (t = { ...bi, ...("object" == typeof t ? t : {}) }), a("focustrap", t, vi), t;
  }
 }
 const Ai = "modal",
  Ti = "Escape",
 ...
 class Mi extends B {
  ...
  _getConfig(t) {
   return (t = { ...Oi, ...U.getDataAttributes(this._element), ...("object" == typeof t ? t : {}) }), a(Ai, t, Ci), t;
  }
  _showElement(t) {
 ...
 class qi extends B {
  ...
  _getConfig(t) {
   return (t = { ...Bi, ...U.getDataAttributes(this._element), ...("object" == typeof t ? t : {}) }), a(Hi, t, Ri), t;
  }
  _initializeBackDrop() {
 ...
 j.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function (t) {
  ...
  j.on(window, "load.bs.offcanvas.data-api", () => V.find($i).forEach((t) => qi.getOrCreateInstance(t).show())),
  R(qi),
  g(qi);
 ...
 const Yi = "tooltip",
  ...
  Zi = { AUTO: "auto", TOP: "top", RIGHT: m() ? "left" : "right", BOTTOM: "bottom", LEFT: m() ? "right" : "left" },
  Ji = {
   animation: !0,
 ...
 class dn extends B {
  ...
  setElementContent(t, e) {
   if (null !== t)
    return o(e)
     ...
     : void (this._config.html ? (this._config.sanitize && (e = Xi(e, this._config.allowList, this._config.sanitizeFn)), (t.innerHTML = e)) : (t.textContent = e));
  }
  getTitle() {
  ...
  _leave(t, e) {
   (e = this._initializeOnDelegatedTarget(t, e)),
    t && (e._activeTrigger["focusout" === t.type ? hn : cn] = e._element.contains(t.relatedTarget)),
 ...
 class En extends B {
  ...
  _getConfig(t) {
   return ((t = { ..._n, ...U.getDataAttributes(this._element), ...("object" == typeof t && t ? t : {}) }).target = r(t.target) || document.documentElement), a(gn, t, bn), t;
  }
  _getScrollTop() {
  ...
  _activate(t) {
   ...
   i.classList.add(vn),
    i.classList.contains("dropdown-item")
     ? V.findOne(".dropdown-toggle", i.closest(".dropdown")).classList.add(vn)
     : V.parents(i, ".nav, .list-group").forEach((t) => {
        V.prev(t, ".nav-link, .list-group-item").forEach((t) => t.classList.add(vn)),
 ...
 class jn extends B {
  ...
  _getConfig(t) {
   return (t = { ...Pn, ...U.getDataAttributes(this._element), ...("object" == typeof t && t ? t : {}) }), a(xn, t, this.constructor.DefaultType), t;
  }
  _maybeScheduleHide() {
 ...
 return R(jn), g(jn), { Alert: W, Button: z, Carousel: st, Collapse: pt, Dropdown: ci, Modal: Mi, Offcanvas: qi, Popover: mn, ScrollSpy: En, Tab: Ln, Toast: jn, Tooltip: dn };
});
